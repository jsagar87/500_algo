...
public class PrimsMSTEager extends MST {
    private boolean marked[] ;
    private MinPQ<Edge> PQ;
    private Queue<Edge> MST;

    public PrimsMSTEager(EdgeWeightedGraph G) {
    ...
    public static void main(String[] args) {
        ...
        Edge E1 = new Edge(0, 1, 0.4);
        Edge E2 = new Edge(0, 2, 0.3);
        Edge E3 = new Edge(0, 3, 0.2);
        Edge E4 = new Edge(0, 4, 0.1);
...
//        PrimsMSTEager mst = new PrimsMSTEager(G);
